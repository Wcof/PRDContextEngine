---
name: pm-assumption
description: Use when the user asks for assumption identification or risk mapping, mentions 假设识别、assumption、风险假设、risk assumption、identify assumptions、prioritize assumptions、8 类风险、assumption mapping、risk category.
metadata:
  internal: true
---
