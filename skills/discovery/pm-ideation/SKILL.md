---
name: pm-ideation
description: Use when the user asks for brainstorm or ideation, mentions 头脑风暴、brainstorm、ideation、创意、实验方案、experiment ideas、新旧场景、optimize vs explore、方案发散.
metadata:
  internal: true
---
