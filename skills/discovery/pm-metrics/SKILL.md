---
name: pm-metrics
description: Use when the user needs initial north star and metrics framework setup, mentions 北极星指标、north star、NSM、input metric、指标体系、metrics framework、OMTM、核心指标、价值度量、指标星座.
metadata:
  internal: true
---
