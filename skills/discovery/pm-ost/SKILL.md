---
name: pm-ost
description: Use when the user asks for opportunity solution tree or discovery structuring, mentions 机会方案树、OST、opportunity solution tree、Teresa Torres、continuous discovery、机会优先级、方案对比、assumption testing.
metadata:
  internal: true
---
